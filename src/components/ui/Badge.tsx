...
import type { EventStatus, OrderStatus, TicketStatus } from '@prisma/client';
...
export const TICKET_TONE: Record<TicketStatus, BadgeTone> = {
  VALID: 'success',
  CHECKED_IN: 'primary',
  VOID: 'danger',
};

export const EVENT_TONE: Record<EventStatus, BadgeTone> = {
  DRAFT: 'warning',
  PUBLISHED: 'success',
  CANCELLED: 'danger',
};
