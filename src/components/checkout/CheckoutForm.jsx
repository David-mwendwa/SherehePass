...
import { checkoutAction } from '@/app/events/[slug]/checkout/actions';
import { cn } from '@/lib/cn';
import { formatKes } from '@/lib/format';

export function CheckoutForm({ event, lines, user, totalCents }) {
...
function MethodOption({ icon: Icon, title, body, selected, onSelect }) {
  return (
    <button
      type="button"
      role="radio"
...
function SubmitButton({ totalCents, free }) {
