 ...
 */
/**
 * The signed-in user as every server surface sees them. Derived from the query
 * rather than declared, so adding a column to the select below widens this type
 * automatically and removing one breaks the pages that were reading it.
 */
